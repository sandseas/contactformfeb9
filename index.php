...
$email_address = 'sandseas1@icloud.com';

// Set the subject line for email messages
$subject = 'New Contact Form Submission For Review using C9 IDE';
...
<html>
	<head>
		<meta charset="utf-8">
		<title>January PHP Contact Form</title>
	...
	<section class="section" id="contact-form">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h1>We would love to hear from you!!  Enter your message below</h1>
					<?php if ( ! empty( $errors ) ) : ?>
					<div class="errors">
